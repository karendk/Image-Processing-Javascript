  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align: justify;">
        <b>Citra Editor (Leaked)</b><br>
        This application is for image processing with a simplest alogarithm. Become the one to improve our apps. Enjoy the feature, and wait for the new effects.<br><br>
        <table>
